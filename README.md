...
1. **Экран «Акции»** — карточки ресторанов, внутри каждой — акции сети.
   Поиск сверху ищет по бренду, адресу, названию акции и товара.
2. Раскройте акцию — у каждого товара цветной статус («Есть» / «Кончилось» /
   «Спорно» / «Нет данных») и давность последнего отчёта.
3. Стоите в ресторане и видите товар? Жмите **«Отметить наличие»**: по каждому
   ...
   30 минут (кулдаун).
4. **Карта** — те же точки на карте, маркеры в цветах сетей. Тап по маркеру —
   шторка с акциями и той же кнопкой отчёта. «📍» центрирует карту на вас.
5. Нашли акцию, которой нет в сервисе? **«+ Заявить акцию»** (кнопка на главном
   экране и в профиле): бренд, название, товары по одному в строке → уйдёт на
   модерацию. Статус заявки виден в **профиле**.
